...
namespace TB_Browser.UI.Controls
{
    public partial class TabBar : UserControl
    {
        ...
        private void AddTabUI(TabModel t)
        {
            ...
            var btn = new Button { Content = t.Title, Style = (Style)FindResource("ChromeTabBtn"), Tag = t.Id };
            var close = new Button { Content = "✕", Width = 16, Height = 16, Background = Brushes.Transparent, BorderThickness = new Thickness(0), Foreground = (Brush)FindResource("ChromeDisabled"), Margin = new Thickness(6,0,0,0), FontSize = 10 };
